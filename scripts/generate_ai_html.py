...
with open("top10_products_macorner.html", "r", encoding="utf-8") as f:
    html_content = f.read()
...
# Replace the mockup SVG references with the new Pollinations AI URLs
html_content = re.sub(r'src="\./mockups/mockup_[^"]+\.svg"', replacer, html_content)

with open("top10_products_macorner_ai.html", "w", encoding="utf-8") as f:
    f.write(html_content)

print("Đã cập nhật sang file HTML sử dụng hình ảnh AI.")
